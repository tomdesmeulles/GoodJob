...
namespace Ens\GoodJobBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
	...
	public function load(ObjectManager $em)
	{
		...
		$job_sensio_labs->setExpiresAt(new \DateTime('2014-12-20'));
		...
		$job_extreme_sensio->setExpiresAt(new \DateTime('2014-12-10'));
		...
		//ajout de bcp d'offres pour le test
